...
const StarOnGithubButton: React.FC<{
  ...
  const baseClass =
    variant === 'outline'
      ...
      : 'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 h-10 px-4 py-2 bg-gray-900 hover:bg-gray-950 text-white transition-all duration-200';
